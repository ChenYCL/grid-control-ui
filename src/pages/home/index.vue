          ...
          <div>
            <div class=" p-3 flex-auto justify-center leading-6">
              ...
              <div class="relative w-full mb-3 mt-1">
                ...
                <input v-model="params.symbol" type="text"
              ...
              <div class="relative w-full mb-3">
                ...
                <input v-model="params.a" type="number"
                  class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full"
              ...
              <div class="relative w-full mb-3">
                ...
                <input v-model="params.b" type="number"
                  class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full"
              ...
              <div class="relative w-full mb-3">
                ...
                <input v-model="params.count" type="number"
                  class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full"
              ...
              <div class="relative w-full mb-3">
                ...
                <input v-model="params.dx" type="number"
                  class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full"
              ...
              <div class="relative w-full mb-3">
                ...
                <input v-model="params.size" type="number"
                  class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full"
...
client.onData.subscribe(() => {
  data = {
    'time': client.realDB.mutableData.time,
    ...data,
